  ...
  if (cartItems.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-8">
        ...
        <Link to="/" className="hover:bg-dark-green h-12 w-36 rounded-xl border-2 border-solid border-black bg-light-green hover:text-white flex items-center justify-center">
          Continue Shopping
        </Link>
      </div>
    );
